...
/*    @Override
    ...
    public void onCreate()
    {
        ...
        UsbSerial.SERVICE_CONNECTED = true;
        setFilter();
    ...
    {
        super.onDestroy();
        UsbSerial.SERVICE_CONNECTED = false;
    }
    ...
    */
    ...
    private void findSerialPortDevice()
    {
        ...
        if (!usbDevices.isEmpty()) {
            ...
            for (Map.Entry<String, UsbDevice> entry : usbDevices.entrySet()) {
                ...
                if (deviceVID != 0x1d6b && (devicePID != 0x0001 || devicePID != 0x0002 || devicePID != 0x0003) && cpt==0)
                {
    ...
    private class ConnectionThread extends Thread
    {
        @Override
        public void run() {
            serialPort = UsbSerialDevice.createUsbSerialDevice(device, connection, 2);
            if (serialPort != null) {
                if (serialPort.open())
                {
